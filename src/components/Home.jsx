...
export function Home () {
  return (
    <section className=''>
      ...
      <header className='p-3 overflow-hidden'>

        <section className='flex flex-col gap-3 justify-center items-center max-w-2xl my-0 mx-auto backdrop-blur-sm p-5'>
          <header className='mt-10'>
            <h1 className='text-4xl md:text-6xl lg:text-6xl text-primary  font-bold'>
              Guarderia Matanzas
            </h1>
          </header>
