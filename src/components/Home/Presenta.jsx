    ...
    return(
        <section className="max-w-xl mx-auto md:max-w-5xl p-5 mt-12">
			...
			<div data-aos="fade-right" className="md:w-5/12 ">
				...
				<p className=" lg:pr-14 font-semibold opacity-80">En <span className="uppercase text-yellow-500 font-semibold">guardy-yamy</span> entendemos que los primeros años son fundamentales para el desarrollo integral del niño. Es por esto que proveemos un ambiente estimulante a través del juego, donde potenciamos sus habilidades sociales, motrices y creativas.</p>
