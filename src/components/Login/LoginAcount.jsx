...
export function LoginForm({hancleClik}){
    return( <div className='w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24'>
    <div className='mx-auto max-w-lg text-center relative'>
      ...
      <button className=" block text-center w-full" onClick={hancleClik}>Create Acount  </button>
    </div>
